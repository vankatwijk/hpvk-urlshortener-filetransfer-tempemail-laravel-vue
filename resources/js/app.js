...
Vue.filter('momentDayTime', function(text) {
    return moment(text).format('MMM D HH:mm')
})
...
Vue.component('links-tree-list-dashboard', require('./components/dashboard/LinksTreeListDashBoard').default)
